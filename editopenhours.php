  ...
  <section class="section bg-image overlay" style="background-image: url('images/adminback.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading text-white" data-aos="fade">Open Hours</h2>
          </div>      
        </div>
      </div>
    </section>
    ...
    <section class="section bg-image overlay" style="background-color: lightblue;">
      ...
      <div class="container">
        <h3 style="color: white; text-align: center;">Open Hours</h3>
        <br>
    ...
    if(mysqli_num_rows($run)<1){
        ...
        while($data=mysqli_fetch_assoc($run)){
            ...
            <tr>
                    ...
                    <td><form action="edithours.php?sid=<?php echo $data['Day'];?>" method="post"> <input type="text" name="newhours"> <input type="submit" name="submit" value="Edit"></form></td> 
            </tr>
